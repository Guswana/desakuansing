    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <table id="table-kodeisian-alias" class="table table-bordered">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $alias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $isian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="bold" data-index="<?php echo e($isian->id); ?>">
                            <td><input type="text" class="form-control" name="judul_kodeisian[]" readonly value="<?php echo e($isian->judul); ?>" maxlength="10" /></td>
                            <td><input type="text" class="form-control" name="alias_kodeisian[]" readonly value="<?php echo e($isian->alias); ?>" /></td>
                            <td><input type="text" class="form-control" name="content_kodeisian[]" readonly value="<?php echo e($isian->content); ?>" /></td>
                            <td>
...
<?php echo $__env->make('admin.pengaturan_surat.partials.modal_kodeisian', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\desakuansing\resources\views/admin/pengaturan_surat/partials/pengaturan_kodeisian.blade.php ENDPATH**/ ?>