...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <a href="<?php echo e(ci_route('penduduk')); ?>" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Data Penduduk"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Data Penduduk</a>
        </div>
        <div class="box-body">
                            ...
                            <ol>
                                ...
                                <li>Data yang dibutuhkan untuk Impor dengan memenuhi urutan format dan aturan data pada tautan
                                    ...
                                    <div class="timeline-footer col-sm-12">
                                        <a href="<?php echo e(asset('import/FormatImporExcel.xlsm')); ?>" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" wrap><i class="fa fa-download"></i> Aturan dan Contoh Format Data</a>
                                        <a href="<?php echo e(asset('import/contoh_penduduk.xlsx')); ?>" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" wrap><i class="fa fa-download"></i> Contoh Data Penduduk Ekspor</a>
                                    </div>
                                </li>
                            </ol>
                        </div>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\desakuansing\resources\views/admin/penduduk/impor.blade.php ENDPATH**/ ?>