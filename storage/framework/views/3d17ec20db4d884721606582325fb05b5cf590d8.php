<div class="box box-widget">
    <div class="box-footer no-padding">
        <ul class="nav nav-stacked">
            ...
            <li <?php echo e(jecho($selectedNav, 'rekapitulasi', 'class="active"')); ?>><a href="<?php echo e(ci_route('bumindes_penduduk_rekapitulasi/clear')); ?>">Buku Rekapitulasi Jumlah Penduduk</a></li>
            ...
            <li <?php echo e(jecho($selectedNav, 'ktpkk', 'class="active"')); ?>><a href="<?php echo e(ci_route('bumindes_penduduk_ktpkk/clear')); ?>">Buku KTP dan KK</a></li>
        </ul>
    </div>
</div>
...
<?php /**PATH C:\laragon\www\desakuansing\resources\views/admin/bumindes/penduduk/side.blade.php ENDPATH**/ ?>