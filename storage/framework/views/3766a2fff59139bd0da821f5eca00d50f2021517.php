    ...
    <div class="box-body">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs customized-tab" id="tabs">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $suratMaster->form_isian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if($item == 'individu'): ?>
                        <?php continue; ?>
                    <?php endif; ?>
                    <li class="ui-list-tab" id="list-<?php echo e($item); ?>" data-name="<?php echo e($item); ?>">
                        <a id="nav-tab-<?php echo e($item); ?>" href="#tab-<?php echo e($item); ?>" data-toggle="tab"><?php echo e(str_replace('_', ' ', $value->judul ?? ucwords(str_replace('_', ' ', $item)))); ?></a>
                ...
                <div class="tab-pane active" id="form-utama">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control input-sm required judul isi-judul" name="judul" value="<?php echo e($suratMaster->form_isian->individu->judul ?: 'Utama'); ?>" minlength="3" maxlength="20">
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\desakuansing\resources\views/admin/pengaturan_surat/tinymce.blade.php ENDPATH**/ ?>