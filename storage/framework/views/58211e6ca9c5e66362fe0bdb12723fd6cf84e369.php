    ...
    <div class="box-body form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-2">
                        <input type="number" class="form-control input-sm" id="masa_berlaku" name="masa_berlaku" onchange="masaBerlaku()" value="<?php echo e($suratMaster->masa_berlaku ?? 1); ?>">
                    </div>
                    <div class="col-sm-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn-ok">
                    <a href="<?php echo e(ci_route('surat_master.restore_surat_bawaan', $suratMaster->url_surat)); ?>" class="btn btn-social btn-success btn-sm" id="ok-restore"><i class="fa fa-refresh"></i> Kembalikan</a>
                </a>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\desakuansing\resources\views/admin/pengaturan_surat/umum.blade.php ENDPATH**/ ?>