...
@php $shalat_aktif = theme_config('shalat_aktif', ''); @endphp

@if (theme_config('shalat_aktif') == 'true')
	<script>
	...
	@elseif (theme_config('kode_kota', true))	
		<script>
					...
					<div class="jadwal-title">
						<div class="flexleft">
							<div>
								...
								<h3 class="color-1"><b>Wilayah {{ ucwords(setting('sebutan_kabupaten')) }} {{ ucwords($desa['nama_kabupaten']) }}</b></h3>
							</div>
						</div>
						<div class="shalat-bottom flexleft" style="align-self: end;"><img src="{{ theme_asset('images/pngfile/shalat.png') }}" /><span id="tanggalwaktu"></span></div>
					</div>
					<script>
						var tw = new Date();
				...
				<div class="jadwalshalat-isi">
					<div class="rowsame margin-minlr-5">
						<div class="jadwal-box2 bgcolor-soft1 bordercolor-1 flexcenter">
							...
							<div class="mosque"><img src="{{ theme_asset('images/svgfile/mosque.svg') }}" /></div>
