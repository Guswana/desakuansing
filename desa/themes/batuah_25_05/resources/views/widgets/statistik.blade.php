...
@push('styles')
<style type="text/css">
	.population-item:nth-child(1){background:url({{ theme_asset('images/svgfile/man.svg') }}) center right;background-size:40px auto;background-repeat:no-repeat;}
	.population-item:nth-child(2){background:url({{ theme_asset('images/svgfile/woman.svg') }}) center left;background-size:40px auto;background-repeat:no-repeat;}
...
<div class="col-default" style="margin-top:10px !important;">
	...
	<div class="statistik-inner">
		...
		@foreach($stat_widget as $data)
			...
			<div>
			<img class="flip-vertical-right" src="{{ theme_asset('images/pngfile/populasi.png') }}"/>
			<p>Populasi</p>
			<h2 class="color-2">
