				...
				<div class="padding-leftright-10">
					...
					<div class="noprint">
						...
						<div class="flexcenter mb-15">
							<a class="b-btn bgcolor-1 flexcenter <?= ($tipe == 0) ? 'bgcolor2' : 'bgcolor2' ?> btn-xs" onclick="switchType(this);" style="cursor:pointer;margin:0 3px;">
								<p>Pie Chart</p>
							</a>
							<a href="{{ ci_route(" data-statistik.{$slug_aktif}.cetak.cetak") }}?tahun={{ $selected_tahun }}" class="b-btn bgpink flexcenter btn-xs" style="cursor:pointer;margin:0 3px;">
								<p>Cetak</p>
							</a>
							...
							<a href="{{ ci_route(" data-statistik.{$slug_aktif}.cetak.unduh") }}?tahun={{ $selected_tahun }}" class="b-btn bgcolor-3 flexcenter btn-xs" style="cursor:pointer;margin:0 3px;">
								<p>Unduh</p>
							</a>
						</div>
					</div>
                    ...
                    <tr>
						...
						<div class="flexcenter mb-15">
							<p style="margin-top:10px;">Diperbarui pada : {{ tgl_indo($last_update); }}</p>
						</div>
					</div>
