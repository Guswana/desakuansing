...
<div class="mainpage">
	...
	<div class="col-default margin-top-10" style="padding-top:10px!important;">
				<div class="bodypage bgwhite bordergrey">
					<div class="headsmall headstat-lebar padding-leftright-10 flexcenter" style="padding: 10px 10px 5px !important;">
						...
						<div>
						<h3 class="color-1">SOTK</h3>
						<p>Struktur Organisasi dan Tata Kerja {{ setting('sebutan_pemerintah_desa') }}</p>
						</div>
					</div>
					<div class="sotk">
