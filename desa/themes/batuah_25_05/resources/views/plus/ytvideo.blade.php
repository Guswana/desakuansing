...
@php $galerivideo = theme_config('galerivideo', ''); @endphp
@php $video1 = theme_config('video1', ''); @endphp
@php $video2 = theme_config('video2', ''); @endphp
@php $video3 = theme_config('video3', ''); @endphp
@php $video4 = theme_config('video4', ''); @endphp
@php $video5 = theme_config('video5', ''); @endphp

@if (theme_config('galerivideo') == 'true')	
